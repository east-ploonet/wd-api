...
@Data
public class IssueTicketVo extends BaseVo implements Serializable {
	...
	public IssueTicketVo() {}

	public IssueTicketVo(long fk_assign_staff) {
		this.fk_assign_staff = fk_assign_staff;
	}

	public IssueTicketVo(IssueTicketDTO issueTicketDTO) {
